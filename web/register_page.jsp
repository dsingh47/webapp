...
<html>
            ...
            <div class="container">
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
      <form id="reg-form" action="ReigsterServlet" method="Post">
  ...
  <div class="form-group">
    ...
    <input name="user_email" type="email" class="form-control" id="user_name" aria-describedby="emailHelp" placeholder="Enter email">
